...
/* What does enum do?
 *
 * priority = FOREGROUND (priority will have int value 0)
 * priority = BACKGROUND (priority will have int value 1)
 */
...
typedef struct process
{
    ...
    processData *Data; /* pointer to processData struct */
    priority foreOrback; /* depending on input of 0(foreground), or 1(background), will decide which queue */
    int processAddedToQueueCounter; /* tracks which step number process was added to queue */
